...
const AboutUs = ({ className }: AboutUsProps) => {
  return (
    <Section sectionClassName={cn("pb-[30px] lg:pb-32 relative z-20", className)}>
      <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
        <div className="flex flex-col items-center gap-5 text-center md:items-start md:text-left lg:ml-18 px-3.75">
          ...
          <p className="max-w-xl md:text-[20px]/[34px] text-center md:text-left mx-auto md:mx-0 text-gray-primary mb-7.75">
            ...
            Bei SemiCare begleiten wir Senioren und Seniorinnen mit dem Ziel, ihre Lebensqualität zu erhalten und ihnen ein gutes
            und sicheres Leben in den eigenen vier Wänden zu ermöglichen.
          </p>
          ...
          <div>
            <h4 className={"text-2xl/[28px] font-secondary mb-1"}>Brauchen Sie Beratung?</h4>
            <h4 className={"text-4xl/[42px] text-primary font-secondary mb-1"}>089 5707 42 19</h4>
          </div>
        </div>
        <div className="w-full h-full flex items-center justify-center">
          <div className={"relative w-[80%]"}>
            <figure className="relative z-20">
              <img src={aboutUsImg.src} alt={"Image of doctor with play button at the center"} className="w-full h-auto" />
            </figure>

            <figure className="absolute -top-7.5 -right-7.5">
              <img src={topGreenImg.src} alt={"Green retangle image"} className="w-22.5 h-22.5" />
            </figure>

            <figure className="absolute -bottom-7.5 -left-7.5 ">
              <img src={bottomPurpleImg.src} alt={"White retangle image with purple border"} className="w-22.5 h-22.5" />
            </figure>
          </div>
        </div>
      </div>
