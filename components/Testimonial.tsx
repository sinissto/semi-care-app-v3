  ...
  return (
    <Section>
      <div className="relative max-w-[90%] mx-auto bg-gray-50 rounded-3xl shadow-sm text-center px-3.75 py-16">
        ...
        <figure>
          <img src={quoteImg.src} alt={"Quote Icon"} className="w-[55px] h-[42px] mx-auto mb-8" />
        </figure>
        ...
        <p className="text-[16px]/[28px] md:text-xl/[30px] lg:text-2xl/[36px] text-gray-primary italic font-secondary max-w-3xl mx-auto">
          ...
          occaecat cupidatat non proident deserunt mollit anim id est laborum.
        </p>
        ...
        {/* Name */}
        <h3 className="text-xl md:text-2xl/[30px] font-secondary font-normal text-black">Max Mustermann</h3>
        <p className="text-[16px]/[24px] text-gray-primary mt-1">Sohn von Anton Mustermann</p>
